...
echo '<p>Here you can delete or add email accounts. You can also reset the password if your users forget them.</p>';
...
echo '<div class="create_form">';
echo '<h3>Create new</h3>';
echo '<p>To make a "catch all" alias that redirects everything sent to an entire domain to one user, type it like this:<br>Source: @domain-to-catch.com<br>Destination: user@to-get-it-all.com</p>';
